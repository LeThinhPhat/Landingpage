            ...
            <div className="space-y-6">
              ...
              <div>
                <textarea
                  ...
                  rows={5}
                  className="w-full px-2 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent bg-white text-gray-800 placeholder-gray-500 font-medium resize-none"
                />
              </div>
                ...
                >
                  ...
                  >
                    <div className="px-4 sm:px-6 pb-5 pt-2">
                      <div className="w-12 h-0.5 bg-yellow-400 mb-3" />
