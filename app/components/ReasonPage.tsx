...
// ✅ Next.js alias import (đổi assets -> asset nếu thư mục bạn là app/asset)
import servicepic1 from "@/public/assets/servicepic1.jpg";
import servicepic2 from "@/public/assets/servicepic2.jpg";
...
const ReasonPage = () => {
  ...
  //  Memo để images không tạo mới mỗi render
  ...
  return (
    <section className="bg-gray-50 py-20 overflow-hidden">
      {/* ❗Nếu bạn thấy lề 2 bên quá rộng: giảm px-6 xuống px-3/px-2 */}
        ...
        <main className="container mx-auto px-12 lg:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative max-w-2lg mx-auto lg:mx-0">
              ...
              <div className="absolute -top-6 -right-6 w-32 h-32 bg-yellow-400/10 rounded-full blur-3xl -z-10" />
              <div className="absolute -bottom-6 -left-6 w-40 h-40 bg-blue-400/10 rounded-full blur-3xl -z-10" />
