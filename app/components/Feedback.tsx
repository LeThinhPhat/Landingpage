...
// ✅ Nếu bạn có ảnh local thì import kiểu này:
// import bg1 from "@/app/asset/bg1.jpg";
// import bg2 from "@/app/asset/bg2.jpg";
// import bg3 from "@/app/asset/bg3.jpg";

// ⚠️ Với code hiện tại bạn đang dùng URL online => KHÔNG cần import @/app/asset cho ảnh.
// (Nếu muốn chuyển bg/avatars về local, mình làm thêm bản local cho bạn.)
...
type Testimonial = {
  ...
  position: string;
  company: string;
  image: string; // avatar URL hoặc local path
  feedback: string;
  bgImage: string; // background URL hoặc local path
};
...
const Feedback = () => {
  ...
  return (
    <section className="relative w-full h-[500px] overflow-hidden">
      {/* Background Images (dùng CSS background vì là URL) */}
            ...
            >
              <div className="flex flex-row items-center gap-8">
                ...
                <div className="flex-shrink-0">
                  <div className="relative w-36 h-48 md:w-44 md:h-56 rounded-lg overflow-hidden border-4 border-white shadow-2xl bg-white">
                    <Image
                      src={t.image}
                      alt={t.name}
                      fill
                ...
                <div className="flex-1">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-400 text-sm mt-1">{t.company}</p>
                  </div>
